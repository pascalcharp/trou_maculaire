...
class DLM_module(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train_loss", ts_loss, on_epoch=True, prog_bar=True, logger=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("validation_loss", vs_loss, on_epoch=True, prog_bar=True, logger=True)
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log("test_auroc", on_epoch=True, logger=True)
        return ts_loss
